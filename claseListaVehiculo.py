...
class ListaVehiculos:
    ...
    def diccionarios_a_vehiculos(self, diccionarios_vehiculos):
        vehiculos = []
        for diccionario in diccionarios_vehiculos["vehiculos"]:
            modelo = diccionario["modelo"]
            puertas = diccionario["puertas"]
            color = diccionario["color"]
            precio_base = diccionario["precio_base_venta"]
            usado = True if diccionario["patente"] else False
            marca = diccionario["marca"]
            patente = diccionario["patente"]
            año = diccionario["anio"]
            kilometraje = diccionario["kilometraje"]
            vehiculo = Vehiculo(modelo, puertas, color, precio_base, usado, marca, patente, año, kilometraje)
